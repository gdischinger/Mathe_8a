...
<img src="./Bilder/KreisMittelpunktRadius.png" width="200" height="200" />
...
### [Kreisumfang](https://gdischinger.github.io/Mathe_8a/03FormelnErstellen/Kreisumfang.html)


### [Kreisfläche](https://gdischinger.github.io/Mathe_8a/03FormelnErstellen/Kreisflaeche.html)
...
<!--                    &= \pi \cdot (39,93m)² \approx \\ -->
<!--                    & \approx 5008,97 m² \end{align}$$ -->
...
<!-- $$ \begin{align} A &= \pi \cdot (30cm)^2 \approx \\ -->
<!--                     &\approx 2827,43 cm^2 \approx \\ -->
<!--                     & \approx 0,28 m ^2 \end{align} $$ -->
...
```{r, 'kable'}
```
<br> |Länge der Schnur (in Metern) | Neu hinzukommende Fläche (in m²)
------|------|-----
1. Tag | |
2. Tag | |
3. Tag | |
...
<!-- <br><br> -->
<!-- In welchem Verhältnis muss der Radius $r_1$ des inneren Kreises zur Breite $b$ des Ringes stehen, damit die Fläche des Ringes gleich der Kreisfläche $k_1$ ist? -->
