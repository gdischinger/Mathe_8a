...
Gegeben ist:
  ...
  2. die Höhe $h=?$ und
  3. der Hinweis, dass die Seite $c$ dreimal so lang ist wie die Seite $a$, also: $c=?$.
...
Gegeben ist:
  ...
  3. der Hinweis, dass die Seite $c$ dreimal so lang ist wie die Seite $a$, also: $c= 3 \cdot a$.
  
Setzte diese Informationen in die Formel zur Berechnung des Flächeninhaltes eines Trapezes ein.


#### Tipp 3
Wenn du alle Informaitonen, die im Text stecken, in die Formel zur Berechnung des Flächeninhaltes eines Trapezes einsetzt, erhältst du folgende Gleichung:
