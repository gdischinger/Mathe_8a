...
```{r dirac2, animation.hook="gifski", interval=1.3, fig.align="center", echo=FALSE}
xxd <- c(1,2,3,4,5,6)
xxd <- c(xxd,rev(xxd))
for(i in 1:length(xxd)){
  meinDreieck(B = c(8,0), C = c(6,xxd[i]))
...
#### Tipp 1
Notiere dir, welche Informationen in der Aufgabe gegeben werden.

Gegeben ist:

  1. Der Flächeninhalt: $A= ?$
  2. Ein Hinweis: Die Höhe $h_c$ ist doppelt so lang ist wie die zugehörige Grundseite $c$. Also: $h_c = ?$
...
Setzte diese Informationen in die Formel zur Berechnung des Flächeninhaltes eines Dreiecks ein.


#### Tipp 3
Wenn du alle Informaitonen, die im Text stecken, in die Formel zur Berechnung des Flächeninhaltes eines Dreiecks einsetzt, erhältst du folgende Gleichung:
